...
namespace QuizAPI.Commands
{
    public class CashedGameSessions : ICashedGameSessions
    {
        ...
        public async Task<IResult> Insert(CachedGameSessionModel cachedGameSession)
        {
            ...
            var sql = $@"INSERT INTO CachedGameSessions (GameSessionId, UserId, Questions, Score, AnsweredQuestions, TotalQuestionCount, SessionTime)
                         VALUES (@GameSessionId, @UserId, @Questions, @Score, @AnsweredQuestions, @TotalQuestionCount, @SessionTime)";
